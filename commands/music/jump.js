...
module.exports = {
    ...
    async execute({ inter }) { 
        ...
        if (!track && !number) inter.reply({ content: `You have to use one of the options to jump to a song ${inter.member}... try again ? <a:redcheck:1042472321329414235>`, ephemeral: true });
