...
module.exports = {
    ...
    async execute({ inter, client }) { 
      ...
      if (Channel.type !== 0) return inter.reply({ content: `you have to send it to a text channel.. <a:redcheck:1042472321329414235>`, ephemeral: true})
      ...
      const embed = new EmbedBuilder()
       ...
       .setFooter({ text: 'Music comes first - Made with heart by North ❤️', iconURL: inter.member.avatarURL({ dynamic: true })})
         ...
         inter.reply({ content: `sending controller to ${Channel}... <a:greencheck:1042472323757920336>`, ephemeral: true})
